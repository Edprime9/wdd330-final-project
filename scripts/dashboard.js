...
function updateStatsDisplay(userData) {
  // Steps
  document.querySelector("#steps-progress span").textContent =
  ...
  // Water
  document.querySelector(".water-fill").style.height =
    `${(userData.water / userData.goals.water) * 100}%`;
  document.querySelector(".water-controls span").textContent =
    `${userData.water}/${userData.goals.water} glasses`;

  // Calories
  document.querySelector(".progress-fill").style.width =
    `${(userData.calories / userData.goals.calories) * 100}%`;
  document.querySelector("#calories-card p").textContent =
    `${userData.calories}/${userData.goals.calories} kcal`;
...
function setupEventListeners() {
  ...
  // Sleep slider
  document
    .querySelector(".sleep-controls input")
